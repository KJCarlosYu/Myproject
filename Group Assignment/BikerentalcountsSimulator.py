...
# Data Exploration
    ...
    with st.expander("Analysis"):
        ...
        tab1.image(image_path, caption='Distribution of each variable', use_column_width=True)
        ...
        image_path = "./count_hour.png"
        tab2.image(image_path, caption='Count numbers vs hour', use_column_width=True)
        ...
        image_path = "./season.png"
        tab2.image(image_path, caption='Count numbers vs season', use_column_width=True)
    ...
    with st.expander("Model development"):
        ...
        tab2.image(image_path, use_column_width=True)
